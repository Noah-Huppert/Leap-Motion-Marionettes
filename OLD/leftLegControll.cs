...
public class leftLegControll : MonoBehaviour {
	...
	void Update () {
		...
		if(controller.IsConnected) //controller is a Controller object
        {
			...
			/*Debug.Log(rightHandRollAverage + " | " + rightHandRollTempAverage + " | " + rightHandRoll + " | " + MAFIndex + " | " + MAFIndexSuming);
			...
			if(rollDif < 10){
				transform.localPosition = new Vector3(-0.375f, leftLegCubeY, 0);
			}
